...
//    private Map<Integer, UChannel> channels;
    ...
    public UChannelMaster getMaster(int masterID){
        UChannelMasterManager manager = (UChannelMasterManager)UApplicationContext.getBean("channelMasterManager");
        return manager.getChannelMaster(masterID);
    }

    public UChannel getChannel(int channelID){
        UChannelManager manager = (UChannelManager)UApplicationContext.getBean("channelManager");
        return manager.getChannel(channelID);
    }

    public UGame getGame(int gameID){
        UGameManager manager = (UGameManager)UApplicationContext.getBean("gameManager");
...
//            if(m.getMasterName() != null && m.getMasterName().equalsIgnoreCase(name)){
//                return m;
//            }
//        }
//        return null;
