...
public class TestApi {
    ...
    public static void generateTestData(){
        ...
        List<UChannel> channels = manager.getAll();
    ...
    private static UDevice generateDevice(UChannel channel){
        ...
        device.setMac("8c:be:be:fd:07:hibernate");
     ...
     * @return
     */
    public static UUser generateUser(UChannel channel, String deviceID){
