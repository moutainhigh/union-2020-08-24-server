...
public class XiaoMiPayCallbackAction extends UActionSupport {
	...
	public void payCallback() {
		...
		try {
			...
			if (!order.getChannel().getCpAppID().equals(this.appId)) {
				Log.d("The appId of the order is invalid. The appId is " + this.appId + "; the valid appId is "
						+ order.getChannel().getCpAppID());
	...
	private boolean isValid(UChannel channel) throws Exception {
		...
		sb.append("appId=").append(this.appId).append("&").append("cpOrderId=").append(this.cpOrderId).append("&");
		...
		sb.append("orderId=").append(this.orderId).append("&").append("orderStatus=").append(this.orderStatus)
				.append("&");
		...
		sb.append("payFee=").append(this.payFee).append("&").append("payTime=").append(this.payTime).append("&")
				.append("productCode=").append(this.productCode).append("&").append("productCount=")
				.append(this.productCount).append("&").append("productName=").append(this.productName).append("&")
