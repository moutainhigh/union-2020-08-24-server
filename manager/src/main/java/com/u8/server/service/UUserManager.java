...
public class UUserManager {
    ...
    //获取指定渠道下的所有用户
    public List<UUser> getUsersBySubChannel(int channelID, int subChannelID){
        String hql = "from UUser where channelID = ? and subChannelID = ?";

        return userDao.find(hql, new Object[]{channelID, subChannelID}, null);
    }
    ...
    public Page<UUser> queryPage(int currPage, int num,
                                 Integer appID, Integer channelID, Integer subChannelID, Integer id, String name, Date beginCreateTime, Date endCreateTime,
