...
public class UChannelMaster implements Serializable{

    private static final long serialVersionUID = 595452197028590815L;

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer masterID;           //渠道商ID号
    private String sdkName;         //当前渠道商所使用的sdk名称, 唯一
