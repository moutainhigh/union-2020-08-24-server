...
public class UUserLog {
    ...
    public static final int OPTYPE_CREATE_ROLE = 1;
    public static final int OPTYPE_ENTER_GAME = 2;
    public static final int OPTYPE_LEVEL_UP = 3;
    public static final int OPTYPE_EXIT_GAME = 4;
