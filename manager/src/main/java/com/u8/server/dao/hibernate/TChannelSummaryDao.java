 ...
 */
@Repository("channelSummaryDao")
public class TChannelSummaryDao extends UHibernateTemplate<TChannelSummary, Integer> {

    public List<TChannelSummary> queryChannelSummaryData(int appID, Date from, Date to){

        String hql = "from TChannelSummary where appID = ?";
