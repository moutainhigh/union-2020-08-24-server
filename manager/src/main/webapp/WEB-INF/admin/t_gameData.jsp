...
<div style="width:90%;height: 80px;">
  ...
  <table>
    <tr style="height: 30px;">
      ...
      <td class="u8_search_item"><a href="javascript:void(0)" class="easyui-linkbutton" onclick="doExport();" style="width:80px">导  出</a></td>
    </tr>
  </table>
...
<script type="text/javascript">
  ...
  function doExport(){
    ...
    location.href="<%=basePath%>/analytics/exportGameSummaryData?appID="+appID+"&beginTime="+beginLoginTime+"&endTime="+endLoginTime;
    ...
    if(inited){
      ...
      $("#data").datagrid({
        ...
        columns:[[
          ...
          {field:'appID', title:'游戏ID', width:30, sortable:true},
          {field:'deviceNum', title:'新增设备', width:20, sortable:true},
          {field:'userNum', title:'新增用户', width:30, sortable:true},
          ...
          {field:'ndau', title:'活跃用户(新)', width:20, sortable:true},
          {field:'wau', title:'7日活跃', width:30, sortable:true},
          {field:'mau', title:'30日活跃', width:30, sortable:true},
          {field:'avg', title:'平均在线时长', width:30, sortable:true},
          {field:'payUserNum', title:'付费用户', width:30, sortable:true},
          {field:'totalPayUserNum', title:'总付费用户', width:30, sortable:true},
          {field:'newPayUserNum', title:'付费用户(新)', width:30, sortable:true},
          {field:'money', title:'收入(元)', width:30, sortable:true}
        ]],
