...
<div id="dialog_add" class="easyui-dialog u8_form"
  ...
  <form id="fm" method="post" novalidate>
    ...
    <div class="u8_form_row">
      <label >密  码：</label>
      <input id="password" type="password" class="easyui-textbox" placeholder="密码(字母和数字,8-20位)" style="height: 25px;" name="password" maxlength="20" required="false"/>
    </div>

    <div class="u8_form_row">
      <label >角  色：</label>
      <%--<input type="text" class="easyui-textbox" name="permission" maxlength="255" novalidate />--%>
      <input id="roles" type="text" style="height: 25px;" name="allroles" maxlength="255"/>
    </div>
